...
void Terrain3D::_generate_triangle_pair(PackedVector3Array &p_vertices, PackedVector2Array *p_uvs,
	...
	Vector3 v2 = _data->_get_mesh_vertex(p_lod, p_filter, xsz);
	Vector3 v3 = _data->_get_mesh_vertex(p_lod, p_filter, xzs);
	Vector3 v4 = _data->_get_mesh_vertex(p_lod, p_filter, xszs);
